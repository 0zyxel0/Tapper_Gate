    ...
    <?php require('navBarScanner.php')?>
        ...
        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" style="background: transparent;">
                                    <tbody>
                        ...
                        <p>
                            ...
                            <input name="crdScanned" id="crdScanned" value=""  style=" background: transparent; width:500px; outline-width: 0;" autofocus>
